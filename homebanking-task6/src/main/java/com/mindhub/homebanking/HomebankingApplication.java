...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository,
		...
		return args -> {
			...
			Card card1 = new Card(client1.getFirstName()+" "+ client1.getLastName(), "1111 1111 1111 1111", LocalDate.now(), LocalDate.now().plusYears(5),CardType.DEBIT, CardColor.GOLD, 131);
			Card card2 = new Card(client1.getFirstName()+" "+ client1.getLastName(), "2222 2222 2222 2222", LocalDate.now(), LocalDate.now().plusYears(5),CardType.CREDIT, CardColor.TITANIUM, 313);
