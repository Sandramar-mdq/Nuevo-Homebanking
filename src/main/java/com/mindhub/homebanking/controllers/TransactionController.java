...
public class TransactionController {
    ...
    public ResponseEntity<Object> createTransaction(
            ...
            @RequestParam("fromAccountNumber") String sourceAccountNumber,
        ...
        Transaction debitTransaction = new Transaction(-amount, description + " DEBITO - " + sourceAccountNumber, TransactionType.DEBITO, LocalDateTime.now(), sourceAccount);
        Transaction creditTransaction = new Transaction(amount, description + " CREDITO - " + destinationAccountNumber, TransactionType.CREDITO, LocalDateTime.now(), destinationAccount);
